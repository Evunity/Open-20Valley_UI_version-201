  ...
  return (
    ...
    >
      ...
      <section className={cn("layout-card !p-3", DASHBOARD_LAYOUT.sectionContentGapClass)}>
        ...
        <div className={cn(vendorChartType === "pie" ? "grid grid-cols-1 lg:grid-cols-4" : "grid grid-cols-1", DASHBOARD_LAYOUT.gridGapClass)}>
          ...
          {vendorChartType === "pie" && (
            <div className="space-y-2 flex flex-col justify-center rounded-lg border border-border/50 bg-background p-2">
