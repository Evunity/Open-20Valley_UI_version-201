    ...
    <div className="space-y-8 pb-6">
      ...
      <div className="space-y-6">
        <div className="space-y-2">
          <h1 className="text-4xl font-bold text-foreground">Incidents & Troubleshooting</h1>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 space-y-4">
          <div className="card-elevated rounded-xl border border-border/50 p-6">
            <div className="mb-4 space-y-1">
              <h2 className="text-lg font-bold text-foreground">Recent Incidents</h2>
        ...
        <div className="lg:col-span-1">
          {currentIncident ? (
            <div className="card-elevated rounded-xl border border-border/50 p-6 sticky top-6">
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-foreground">{currentIncident.impact}</p>
                </div>

                {/* AI Action */}
                <div className="p-3 rounded-lg bg-primary/5 border border-primary/20">
                  <p className="text-xs font-semibold text-primary mb-1">🤖 AI ACTION</p>
                  <p className="text-sm text-foreground">{currentIncident.aiAction}</p>
                </div>
                ...
                <div className="space-y-2 pt-2 border-t border-border">
                  {currentIncident.status !== "resolved" && (
                    <>
                      <button className="w-full py-2 px-3 bg-primary text-primary-foreground rounded-lg hover:bg-primary/90 transition-colors font-medium text-xs">
                        Approve Action
                      </button>
                      <button className="w-full py-2 px-3 border border-border rounded-lg hover:bg-muted transition-colors font-medium text-xs">
                        Escalate
                      </button>
                    </>
                  )}
            ...
            <div className="card-elevated rounded-xl border border-border/50 p-6 sticky top-6 text-center">
      ...
      {currentIncident && (
        <div className="card-elevated rounded-xl border border-border/50 p-6">
          <div className="mb-6 space-y-1">
            <h2 className="text-lg font-bold text-foreground">Timeline of Events</h2>
            <p className="text-sm text-muted-foreground">Incident detection and response history</p>
          </div>
          <div className="space-y-4">
