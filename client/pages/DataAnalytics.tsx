          ...
          <div className="mb-6">
            ...
            <div className="bg-muted/20 rounded-lg p-4 mb-6">
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6 gap-3">
                {/* Country Filter */}
                <div>
                  <label className="block text-xs font-semibold text-muted-foreground mb-1 uppercase">Country</label>
                  <select className="w-full px-2 py-1 rounded border border-border text-xs text-foreground bg-background hover:bg-muted transition-colors">
                ...
                {/* Region Filter */}
                <div>
                  <label className="block text-xs font-semibold text-muted-foreground mb-1 uppercase">Region</label>
                  <select className="w-full px-2 py-1 rounded border border-border text-xs text-foreground bg-background hover:bg-muted transition-colors">
                ...
                {/* Cluster Filter */}
                <div>
                  <label className="block text-xs font-semibold text-muted-foreground mb-1 uppercase">Cluster</label>
                  <select className="w-full px-2 py-1 rounded border border-border text-xs text-foreground bg-background hover:bg-muted transition-colors">
                ...
                {/* Vendor Filter */}
                <div>
                  <label className="block text-xs font-semibold text-muted-foreground mb-1 uppercase">Vendor</label>
                  <select className="w-full px-2 py-1 rounded border border-border text-xs text-foreground bg-background hover:bg-muted transition-colors">
                ...
                {/* Technology Filter */}
                <div>
                  <label className="block text-xs font-semibold text-muted-foreground mb-1 uppercase">Technology</label>
                  <select className="w-full px-2 py-1 rounded border border-border text-xs text-foreground bg-background hover:bg-muted transition-colors">
                ...
                {/* Granularity & Dates */}
                <div>
                  <label className="block text-xs font-semibold text-muted-foreground mb-1 uppercase">Granularity</label>
                  <select className="w-full px-2 py-1 rounded border border-border text-xs text-foreground bg-background hover:bg-muted transition-colors">
                    <option>Days</option>
                    <option>Hours</option>
                  </select>
              ...
              {/* Choose Dates */}
              <div className="mt-3">
                <button className="w-full px-3 py-1 text-xs text-muted-foreground rounded border border-border bg-background hover:bg-muted transition-colors text-left">
                  📅 Choose Dates - Select range
                </button>
              </div>
            </div>
          </div>
