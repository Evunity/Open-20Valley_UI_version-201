  ...
  return (
    <div className="flex h-full flex-col bg-background">
      ...
      <div className="border-b border-border bg-card px-8 py-6">
        ...
        <p className="text-muted-foreground">Platform Configuration, System Controls & Operational Guardrails</p>
      </div>
        ...
        <div className="p-8">
          ...
          {activeTab === 'system' && (
            <div className="space-y-6">
              <div>
                <h2 className="mb-4 text-2xl font-bold text-foreground">System Configuration</h2>
              ...
              <div>
                <h3 className="mb-4 text-xl font-bold text-foreground">Global Kill Switches</h3>
                <div className="space-y-3">
                  {[
                    ...
                    <div key={sw.name} className="flex items-center justify-between rounded-lg border border-border bg-card p-4">
                      <div>
                        <p className="font-semibold text-foreground">{sw.name}</p>
                        <p className="text-sm text-muted-foreground">Emergency control - use with caution</p>
                      </div>
              ...
              <div>
                <label className="flex items-center gap-3 rounded-lg border border-border bg-card p-4">
                  <input
                    type="checkbox"
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">Prevents automations & scripts, allows read-only access</p>
                  </div>
              </label>
              </div>
            </div>
          ...
          {activeTab === 'modules' && (
            <div className="space-y-4">
              <h2 className="text-2xl font-bold text-foreground">Module Configuration</h2>
              {['Alarm', 'Analytics', 'Automation', 'Topology', 'Reports', 'Command Center'].map(module => (
                <div key={module} className="rounded-lg border border-border bg-card p-6">
                  <h3 className="mb-4 font-semibold text-foreground">{module} Module</h3>
                  <div className="space-y-3">
                    ...
                    <div>
                      ...
                      <input
                        ...
                        className="mt-1 w-full rounded-lg border border-gray-300 dark:border-gray-600 px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500 bg-white dark:bg-gray-800 text-foreground"
                      />
                    </div>
                  </div>
                </div>
          ...
          {activeTab === 'integration' && (
            <div className="space-y-4">
              ...
              <div className="space-y-2">
                <h3 className="font-semibold text-foreground">Northbound Integrations</h3>
                {['ServiceNow ITSM', 'Splunk SIEM', 'SMTP Email'].map(int => (
                  <div key={int} className="flex items-center justify-between rounded-lg border border-border bg-card p-4">
                    <div>
              ...
              <div className="space-y-2">
                <h3 className="font-semibold text-foreground">Southbound Integrations</h3>
          ...
          {activeTab === 'retention' && (
            <div className="space-y-4">
              <h2 className="text-2xl font-bold text-foreground">Data & Retention Policies</h2>
              {[
                ...
                <div key={policy.type} className="rounded-lg border border-border bg-card p-6">
                  <h3 className="mb-4 font-semibold text-foreground">{policy.type}</h3>
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      <label className="text-sm font-semibold text-gray-700 dark:text-gray-300">Retention (days)</label>
                      <input type="number" defaultValue={policy.retention} className="mt-1 w-full rounded-lg border border-gray-300 dark:border-gray-600 px-3 py-2 bg-white dark:bg-gray-800 text-foreground" />
                    </div>
                    <div>
          ...
          {activeTab === 'performance' && (
            <div className="space-y-4">
              <h2 className="text-2xl font-bold text-foreground">Performance & Limits</h2>
                ...
                <div className="space-y-4">
                  {[
                    ...
                    <div key={limit.label}>
                      ...
                      <input type="number" defaultValue={limit.value} className="mt-1 w-full rounded-lg border border-gray-300 dark:border-gray-600 px-3 py-2 bg-white dark:bg-gray-800 text-foreground" />
                    </div>
                  ))}
                </div>
              </div>
          ...
          {activeTab === 'automation' && (
            <div className="space-y-4">
              <h2 className="text-2xl font-bold text-foreground">Automation Guardrails</h2>
              <div className="rounded-lg border border-border bg-card p-6">
                <div className="space-y-3">
                  {[
          ...
          {activeTab === 'environment' && (
            <div className="space-y-4">
              <h2 className="text-2xl font-bold text-foreground">Environment & Deployment</h2>
              {['Production', 'Staging', 'Lab'].map(env => (
                <div key={env} className="rounded-lg border border-border bg-card p-6">
                  <h3 className="mb-4 font-semibold text-foreground">{env} Environment</h3>
                  <div className="space-y-3">
                    <div>
          ...
          {activeTab === 'backup' && (
            <div className="space-y-4">
              <h2 className="text-2xl font-bold text-foreground">Backup & Recovery</h2>
              {['Full Daily', 'Incremental Hourly', 'Database Snapshots'].map(policy => (
                <div key={policy} className="rounded-lg border border-border bg-card p-6">
                  <h3 className="mb-4 font-semibold text-foreground">{policy} Backup</h3>
                  <div className="space-y-3">
                    <div>
                      <label className="text-sm font-semibold text-gray-700 dark:text-gray-300">Retention (days)</label>
                      <input type="number" defaultValue={30} className="mt-1 w-full rounded-lg border border-gray-300 dark:border-gray-600 px-3 py-2 bg-white dark:bg-gray-800 text-foreground" />
                    </div>
          ...
          {activeTab === 'branding' && (
            <div className="space-y-4">
              <h2 className="text-2xl font-bold text-foreground">Branding & UI Configuration</h2>
              <div className="rounded-lg border border-border bg-card p-6">
                <div className="space-y-4">
                  <div>
                    <label className="text-sm font-semibold text-gray-700 dark:text-gray-300">Platform Name</label>
                    <input type="text" defaultValue="OSS Platform" className="mt-1 w-full rounded-lg border border-gray-300 dark:border-gray-600 px-3 py-2 bg-white dark:bg-gray-800 text-foreground" />
                  </div>
                  <div>
          ...
          {activeTab === 'audit' && (
            <div className="space-y-4">
              <h2 className="text-2xl font-bold text-foreground">Audit & Change Control</h2>
              <div className="rounded-lg border border-border bg-card p-6">
                <h3 className="mb-4 font-semibold text-foreground">Recent Changes</h3>
                <div className="space-y-2">
                  {[
